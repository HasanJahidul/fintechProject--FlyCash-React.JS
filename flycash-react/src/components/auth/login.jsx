...
const Login  =() => {
    ...
    const handleLogin = () => {
        ...
        axios.post("http://localhost:8000/api/users-login", {
            ...
            // console.log(response.data.officers.email);
            ...
            setError("Please username & password");
        });
    }
                                ...
                                <form className="form">
                                    ...
                                    <div className="card card-login card-white">
                                        ...
                                        <div className="card-footer">
                                            ...
                                            <button type="submit" value={loging ? "Loging..." : "Login"} disabled={loging} className="btn btn-primary btn-lg btn-block mb-3" onClick={handleLogin}>Sign In</button>
