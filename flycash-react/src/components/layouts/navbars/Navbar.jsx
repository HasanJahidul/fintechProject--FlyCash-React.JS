        ...
        <div className="collapse navbar-collapse" id="navigation">
            <ul className="navbar-nav ml-auto">
                ...
                <li className="dropdown nav-item">
                    <Link href="#" className="dropdown-toggle nav-link" data-toggle="dropdown">
                    ...
                    <ul className="dropdown-menu dropdown-menu-right dropdown-navbar">
                        <li className="nav-link">
                            <Link href="#" className="nav-item dropdown-item">Mike John responded to your email</Link>
                        </li>
                        <li className="nav-link">
                            <Link href="#" className="nav-item dropdown-item">You have 5 more tasks</Link>
                        </li>
                        <li className="nav-link">
                            <Link href="#" className="nav-item dropdown-item">Your friend Michael is in town</Link>
                        </li>
                        <li className="nav-link">
                            <Link href="#" className="nav-item dropdown-item">Another notification</Link>
                        </li>
                        <li className="nav-link">
                            <Link href="#" className="nav-item dropdown-item">Another one</Link>
                        </li>
                    </ul>
                </li>
                <li className="dropdown nav-item">
                    ...
                    <ul className="dropdown-menu dropdown-navbar">
                        <li className="nav-link">
                            <Link href="{{ route('customer_profile_edit" className="nav-item dropdown-item">Profile</Link>
                        </li>
                        <li className="nav-link">
                            <Link href="{{ route('profile_passwordChange" className="nav-item dropdown-item">Change Password</Link>
                        </li>
                        <li className="nav-link">
                            <Link href="#" className="nav-item dropdown-item">Settings</Link>
                        </li>
                        <li className="dropdown-divider"></li>
                        <li className="nav-link">
                            <Link href="/logout" className="nav-item dropdown-item" >Log out</Link>
                        </li>
                    </ul>
                </li>
